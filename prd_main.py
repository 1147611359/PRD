...
def get_mse_r2_index(des_num, fold = 5):
  ...
  # define the target function to optimization(maxmal R2 or minmal MSE), the function is r2 or mse = weight * m_mse + (1 - weight) * cv_mse_ave
  weight = 0.5
  mse = [0] * len(m_mse)
  r2 = [0] * len(m_r2)
...
if __name__ == "__main__":
  ...
  with open("result.list", 'r') as result:
